...
class Navigator @Inject constructor() {
    ...
    fun moveToCharacterDetailScreen(viewModel: MainViewModel, characterId: Int) {
        ...
        activity!!.supportFragmentManager
            ...
            .replace(R.id.fragmentContainer,
                SingleCharacterFragment.newInstance(viewModel, characterId))
            .commit()
    ...
    fun moveToEpisodeDetailScreen(viewModel: MainViewModel, episodeId: Int) {
        ...
        activity!!.supportFragmentManager
            ...
            .addToBackStack(null)
            .replace(R.id.fragmentContainer,
                SingleEpisodeFragment.newInstance(viewModel, episodeId))
            .commit()
    ...
    fun moveToLocationDetailScreen(viewModel: MainViewModel, locationId: Int, place: String) {
        ...
        if (place != "") {
            activity!!.supportFragmentManager
                ...
                .addToBackStack(null)
                .replace(R.id.fragmentContainer,
                    SingleLocationFragment.newInstance(viewModel, place))
                .commit()
        } else {
            activity!!.supportFragmentManager
                .beginTransaction()
                .addToBackStack(null)
                .replace(R.id.fragmentContainer,
                    SingleLocationFragment.newInstance(viewModel, locationId))
                .commit()
        }
